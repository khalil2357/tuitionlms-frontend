...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 relative overflow-hidden">
      {/* Background accents */}
      <div 
        className="absolute top-1/4 right-1/4 w-[40vw] h-[40vw] max-w-[600px] max-h-[600px] rounded-full blur-[100px] opacity-30 pointer-events-none"
        style={{ background: 'var(--accent)' }}
      />
      <div 
        className="absolute bottom-1/4 left-1/4 w-[30vw] h-[30vw] max-w-[500px] max-h-[500px] rounded-full blur-[100px] opacity-20 pointer-events-none"
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-[var(--text-muted)]">Join Tuition LMS as a student</p>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="mt-6 text-center text-sm text-[var(--text-secondary)]">
            ...
            <Link to="/login" className="font-semibold text-[var(--accent)] hover:text-[var(--accent-strong)] transition-colors">
              Sign In
            </Link>
          </p>
        </form>
